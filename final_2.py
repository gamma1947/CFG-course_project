...
tsv_file = Path("/home/photon/CFG-course_project/projectData/chr2_200bp_bins.tsv")
tf = 1
TF_indexes = [3,4,5,6]
...
# TF_info_dict = dict(zip(TF_names, TF_indexes))
# print(TF_info_dict)
...
# i = 0
    ...
    # Save and Close
    plt.tight_layout()
    output_file = Path(f"/home/photon/CFG-course_project/metrics_plot{tsv_file.stem}_{TF_names[tf]}_fold_{i}.png")
